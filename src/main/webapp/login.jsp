        ...
        <div id="tabcon">
            <div class="box show">
                <form action="user" method="post" id="loginForm">
                    <%--隐藏域，name值表示用户行为，用于判断执行何种操作--%>
                    <input type="hidden" value="login" name="actionName">
                    <input type="text" class="user yahei16" id="userName" name="userName" value="${resultInfo.resultInfo.uname}" /><br /><br />
                    <input type="password" class="pwd yahei16" id="userPwd" name="userPwd" value="${resultInfo.resultInfo.upwd}" /><br /><br />
                    <input name="duo" type="checkbox" value="1"  class="inputcheckbox"/> <label>记住我</label>&nbsp; &nbsp;
